...
//           response.setContentType("text/html;charset=UTF-8");
        ...
        if (typeImg.equalsIgnoreCase("Quần")) {
            img1 = "img/quan/" + image1;
            img2 = "img/quan/" + image2;
            img3 = "img/quan/" + image3;
            img4 = "img/quan/" + image4;
            img5 = "img/quan/" + image5;
            img6 = "img/quan/" + image6;
        }
        ...
        Image img = new Image(img1, img2, img3, img4, img5, img6);
        Color color = new Color(color1, color2, color3, color4, color5);
        Product product = new Product(id, cate, name, priceF, describer, img1, status, quantity);

        dao.insertProduct(product, color, img);
